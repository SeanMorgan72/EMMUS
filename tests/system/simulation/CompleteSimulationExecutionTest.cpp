...
TEST(
    CompleteSimulationExecutionTest,
    ExecutesConfiguredSequentialWorkloadWithoutGui) {
...
TEST(
    CompleteSimulationExecutionTest,
    ExecutesConfiguredRandomWorkloadWithoutGui) {

    constexpr std::size_t accessCount = 24;
